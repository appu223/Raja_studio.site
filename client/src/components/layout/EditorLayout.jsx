...
export default function EditorLayout({ children }) {
  ...
  const menu = [
    { name: 'My Retouch Queue', path: '/editor/dashboard', icon: 'bi-scissors' },
    { name: 'Darkroom Galleries & Uploads', path: '/editor/galleries', icon: 'bi-images' },
  ];
      ...
      <header className="bg-dark text-white sticky-top py-2 px-3 px-md-4 shadow">
        <div className="container-fluid d-flex justify-content-between align-items-center">
          <div className="d-flex align-items-center gap-2">
            <div className="bg-info text-dark rounded-3 d-flex align-items-center justify-content-center" style={{ width: '38px', height: '38px' }}>
              <i className="bi bi-scissors fs-5"></i>
            </div>
            <div>
              <h6 className="fw-bold mb-0 text-white">RAJA STUDIO</h6>
              <small className="text-info" style={{ fontSize: '0.68rem', letterSpacing: '1px' }}>
          ...
          <div className="d-flex align-items-center gap-3">
            <div className="text-end d-none d-sm-block">
              ...
              <small className="text-white-50">Lead Colorist & Retoucher</small>
            </div>
